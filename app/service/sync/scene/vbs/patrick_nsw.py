...
class PatrickNswVbsSync(SyncTemplate):
    """PATRICK NS PORT BOTANY 的 VBS 同步。

    provider 负责 VBS 爬取；本类负责：
    - 筛选属于本码头的记录
    - 以 patrickNSW operation 查询 VBS
    - 将结果写回 Bitable
    """

    TERMINAL_FULL_NAME = "PATRICK NS PORT BOTANY"
    OPERATION = "patrickNSW"
